...
function CardHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "ui:@container/card-header ui:grid ui:auto-rows-min ui:grid-rows-[auto_auto] ui:items-start ui:gap-1.5 ui:px-6 has-data-[slot=card-action]:ui:grid-cols-[1fr_auto] [.border-b]:ui:pb-6",
        className
      )}
      {...props}
    />
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("ui:flex ui:items-center ui:px-6 [.border-t]:ui:pt-6", className)}
      {...props}
    />
  )
}
