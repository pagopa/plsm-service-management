...
const serverEnvSchema = z.object({
  ...
  FE_SMCR_API_SLACK_CALL_MANAGEMENT_HOOK_PROD_SELFCARE: optionalString,
...
const rawServerEnv = {
  ...
  FE_SMCR_API_SLACK_CALL_MANAGEMENT_HOOK_PROD_SELFCARE:
    process.env.FE_SMCR_API_SLACK_CALL_MANAGEMENT_HOOK_PROD_SELFCARE,
