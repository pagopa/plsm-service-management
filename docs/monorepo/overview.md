...
| **sm-ask-me-fn**        | Azure Function | Chatbot "Ask Me Anything" con integrazione Slack e notifiche email                                 | Slack Bolt, nodemailer, Azure Functions v4, Zod                              | [Dettagli](./apps/sm-ask-me-fn.md)        |
| **sm-certification-fn** | Azure Function | Elaborazione certificazione XML con archiviazione su PostgreSQL                                    | fast-xml-parser, PostgreSQL (pg), Azure Functions v4                         | [Dettagli](./apps/sm-certification-fn.md) |
| **sm-crm-fn**           | Azure Function | Integrazione con Dynamics 365 CRM per la gestione delle relazioni con i clienti                    | Azure Identity, Azure Storage Blob, Azure Functions v4                       | [Dettagli](./apps/sm-crm-fn.md)           |
| **sm-onboarding-fn**    | Azure Function | Flusso di onboarding contratti con event streaming Kafka e serializzazione Avro                    | Kafka, Avro, fp-ts, io-ts, Azure Functions v3                                | [Dettagli](./apps/sm-onboarding-fn.md)    |
| **sm-pf-fn**            | Azure Function | Gestione dati delle Persone Fisiche con archiviazione sicura                                       | Azure Identity, Azure Storage Blob, Azure Functions v4                       | [Dettagli](./apps/sm-pf-fn.md)            |
